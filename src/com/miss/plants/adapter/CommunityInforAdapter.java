package com.miss.plants.adapter;

import java.util.ArrayList;
import java.util.HashMap;

import com.miss.pictureload.ImageLoader;
...
public class CommunityInforAdapter extends BaseAdapter {
   ...
   private Activity activity;
    ...
    public CommunityInforAdapter(Activity a, ArrayList<HashMap<String, String>> d) {
        activity = a;
        data=d;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View vi=convertView;
        if(convertView==null)
        vi = inflater.inflate(R.layout.fragment_community_list_item, null);
        ...
        System.out.println("ͼƬ��url--->"+song.get("icon"));
        return vi;
    }
}