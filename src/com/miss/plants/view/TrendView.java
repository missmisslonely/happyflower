package com.miss.plants.view;


import java.util.ArrayList;
import java.util.List;

import com.miss.plants.weather.WeatherPic;
...
public class TrendView extends View {
	...
	protected void onDraw(Canvas canvas) {
		...
		//int h = this.h;
		int h = this.h/2;
		int h2 = (int) (h - fontHeight+80);//下面的文字
		int h3 = (int) (h - fontHeight - 200);
		 
		int h4 = (int) (h + fontHeight-50);//上面的文字
		int h5 = (int) (h + fontHeight+100);
